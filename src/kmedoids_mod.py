...
## Modified from scikit-learn-extra library
## by: Marc Expòsit Goy
# modifications return the indices of the observations that act as centroids,
# even when using a distance matrix as input.
# See lines 261-269
# modified import on line 31 (see notes there)
...
# from sklearn_extra.cluster._k_medoids_helper import _compute_optimal_swap, _build

# This import was failing because conda did not install _k_medoids_helper, but we can find it on the github repo of package
# https://github.com/scikit-learn-contrib/scikit-learn-extra/blob/master/sklearn_extra/cluster/_k_medoids_helper.pyx
# downloaded manually in this folder, so we just need to import it like that: THIS WORKS ON A JUPYTER NOTEBOOK BUT NOT HERE
# import pyximport # needed to import from a .pyx file
# from dtw_knn_heartadren._k_medoids_helper import _compute_optimal_swap, _build

class KMedoids_mod(BaseEstimator, ClusterMixin, TransformerMixin):
    """k-medoids clustering.
    ...
    def fit(self, X, y=None):
        ...
        # After modification:
        self.cluster_centers_ = medoid_idxs
